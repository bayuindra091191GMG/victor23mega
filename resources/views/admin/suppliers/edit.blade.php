...
@section('title','Ubah Data Vendor '. $supplier->name)
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select id="type" name="type" class="form-control col-md-7 col-xs-12">
                        <option value="REGULAR" {{ $supplier->type === 'REGULAR' ? "selected":"" }}>VENDOR TIDAK TETAP</option>
                        <option value="FIXED" {{ $supplier->type === 'FIXED' ? "selected":"" }}>VENDOR TETAP</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="email" type="email" class="form-control col-md-7 col-xs-12 @if($errors->has('email')) parsley-error @endif"
                           name="email" value="{{ $supplier->email1 }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="email2" type="email" class="form-control col-md-7 col-xs-12 @if($errors->has('email2')) parsley-error @endif"
                           name="email2" value="{{ $supplier->email2 }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="phone" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('phone')) parsley-error @endif"
                           name="phone" value="{{ $supplier->phone1 }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="phone2" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('phone2')) parsley-error @endif"
                           name="phone2" value="{{ $supplier->phone2 }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select id="status" name="status" class="form-control col-md-7 col-xs-12">
                        <option value="1" @if($supplier->status_id == 1) selected @endif>Aktif</option>
                        <option value="2" @if($supplier->status_id == 2) selected @endif>Non Aktif</option>
                    </select>
                </div>
            </div>
