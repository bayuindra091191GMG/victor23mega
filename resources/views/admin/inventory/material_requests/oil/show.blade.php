...
@section('title','Data Material Request Oli '. $header->code)
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="navbar-right">
                ...
                @if(!$isPrCreated)
                    <a class="btn btn-default" href="{{ route('admin.material_requests.oil.edit',[ 'material_request' => $header->id]) }}">UBAH</a>
                @endif
