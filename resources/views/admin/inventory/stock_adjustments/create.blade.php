...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            {{ Form::open(['route'=>['admin.stock_adjustments.store'],'method' => 'post','id' => 'general-form','class'=>'form-horizontal form-label-left']) }}
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a class="btn btn-warning" href="{{ route('admin.stock_adjustments') }}"> Batal</a>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        // autoNumeric
        qtyEditFormat = new AutoNumeric('#depreciation', {
            maximumValue: '999999',
            minimumValue: '0',
            digitGroupSeparator: '',
            decimalPlaces: 0
