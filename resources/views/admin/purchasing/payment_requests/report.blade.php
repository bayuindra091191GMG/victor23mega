...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
            <h2>Laporan Request for Payment</h2>
            <hr/>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            {{ Form::open(['route'=>['admin.payment_requests.download-report'],'method' => 'post', 'id' => 'general-form', 'class'=>'form-horizontal form-label-left']) }}
