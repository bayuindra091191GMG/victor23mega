...
<div class="container">
    ...
    <table class="table" style="font-size: 10px;">
      <thead>
      <tr>
          <th class="text-left" style="width: 20%;">Kode</th>
      ...
      <tbody>
        ...
        @foreach($poHeaders as $item)
            <tr>
                <td colspan="7"><b>{{ $item->code }} - {{ $item->date_string }} - {{ $item->purchase_request_header->material_request_header->code }} - Vendor: {{ $item->supplier->name }} - Dibuat Oleh: {{ $item->createdBy->email }}</b></td>
            </tr>
