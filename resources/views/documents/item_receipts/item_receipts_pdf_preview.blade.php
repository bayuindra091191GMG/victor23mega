...
<div class="container">
 <h3>Laporan Goods Receipt</h3>
    ...
    <span style="font-size: 10px;">Total GR: {{ $grHeaders->count() }}</span>
    {{ Form::open(['route'=>['admin.item_receipts.download-report'],'method' => 'post','id' => 'general-form']) }}
    ...
    <table class="table" style="font-size: 10px;">
      ...
      <tbody>
        @foreach($grHeaders as $item)
            <tr>
                <td colspan="4"><b>{{ $item->code }} - {{ $item->date_string }} - {{ $item->purchase_order_header->code }} - {{ $item->warehouse->name }} - No SJ/SPB: {{ $item->delivery_order_vendor ?? '-' }} - Dibuat Oleh: {{ $item->createdBy->email }}</b></td>
            </tr>
