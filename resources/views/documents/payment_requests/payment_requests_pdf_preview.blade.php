...
<html lang="en">
<head>
    <title>Request for Payment Report</title>
    <meta charset="utf-8">
...
<div class="container">
    <h3>Laporan Request for Payment</h3>
    <span style="font-size: 10px;">Tanggal: {{ $start_date }} - {{ $finish_date }}</span><br/>
    <span style="font-size: 10px;">Total RFP: {{ $rfpHeaders->count() }}</span>
    {{ Form::open(['route'=>['admin.payment_requests.download-report'],'method' => 'post','id' => 'general-form']) }}
    ...
    <table class="table" style="font-size: 10px;">
        ...
        @foreach($rfpHeaders as $header)
            <tr>
                ...
                <td class="text-right">
                    @if($header->type === 'dp')
                        {{ !empty($header->dp_amount) ? $header->dp_amount_string : $header->total_amount_string }}
                    @else
