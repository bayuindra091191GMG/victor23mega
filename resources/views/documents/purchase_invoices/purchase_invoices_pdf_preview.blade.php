...
<div class="container">
    <h3>Laporan Purchase Invoice</h3>
    <span style="font-size: 12px;">Tanggal: {{ $start_date }} - {{ $finish_date }}</span><br/>
    <span style="font-size: 12px;">Total Site: {{ $data->count() }}</span>
    {{ Form::open(['route'=>['admin.purchase_invoices.download-report'],'method' => 'post','id' => 'general-form']) }}
    ...
    <table class="table" style="font-size: 11px;">
        ...
        @foreach($data as $item)
            <tr>
                <td colspan="7">
                    <b>
                        No PI: {{ $item->code }} - {{ $item->date_string }} - Nomor PO: {{ $item->purchase_order_header->code }} - Vendor: {{ $item->purchase_order_header->supplier->name }}
                    </b>
                </td>
            </tr>
