...
<html lang="en">
<head>
    <title>Laporan Purchase Request</title>
    <meta charset="utf-8">
...
<div class="container">
    ...
    {{ Form::open(['route'=>['admin.purchase_requests.download-report'],'method' => 'post','id' => 'general-form']) }}
    ...
    <table class="table" style="font-size: 10px;">
        ...
        @foreach($prHeaders as $header)
            <tr>
                <td colspan="6"><b>{{ $header->code }} - {{ $header->date_string }} - {{ $header->material_request_header->code }} - Departemen: {{ $header->department->name }} - Status: {{ $header->status->description }} - Dibuat Oleh: {{ $header->createdBy->email }}</b></td>
            </tr>
