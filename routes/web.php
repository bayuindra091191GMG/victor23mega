...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => 'auth'], function () {
    ...
    Route::get('delivery_orders/konfirmasi_parsial/{id}/simpan', 'Inventory\DeliveryOrderHeaderController@partialConfirmSubmit')->name('delivery_orders.partial_confirm.store');
...
Route::get('/select-accounts-with-name', 'Admin\AccountController@getAccountsWithName')->name('select.accounts.name');
...
Route::get('/script/delete/purchase-invoice/{id}', 'Admin\ScriptController@deleteInvoice');
